...
unrealRootPath=/media/hdd/UE4.25-Linux
beatRush_WINRootPath=/media/hdd/Unreal Projects/beatRush/beatRush_WIN

gameProjectFile=/media/hdd/Unreal Projects/beatRush/beatRush_WIN/beatRush_WIN.uproject
...
include(beatRush_WINSource.pri)
include(beatRush_WINHeader.pri)
include(beatRush_WINConfig.pri)
include(beatRush_WINIncludes.pri)
include(beatRush_WINDefines.pri)
...
beatRush-Linux-Debug.commands = $$build beatRush Linux Debug  $$args
beatRush-Linux-DebugGame.commands = $$build beatRush Linux DebugGame  $$args
beatRush-Linux-Shipping.commands = $$build beatRush Linux Shipping  $$args
beatRush-Linux-Test.commands = $$build beatRush Linux Test  $$args
beatRush.commands = $$build beatRush Linux Development  $$args

beatRushEditor-Linux-Debug.commands = $$build beatRushEditor Linux Debug  $$args
beatRushEditor-Linux-DebugGame.commands = $$build beatRushEditor Linux DebugGame  $$args
beatRushEditor-Linux-Shipping.commands = $$build beatRushEditor Linux Shipping  $$args
beatRushEditor-Linux-Test.commands = $$build beatRushEditor Linux Test  $$args
beatRushEditor.commands = $$build beatRushEditor Linux Development  $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	beatRush-Linux-Debug \
	beatRush-Linux-DebugGame \
	beatRush-Linux-Shipping \
	beatRush-Linux-Test \
	beatRush \
	beatRushEditor-Linux-Debug \
	beatRushEditor-Linux-DebugGame \
	beatRushEditor-Linux-Shipping \
	beatRushEditor-Linux-Test \
	beatRushEditor \

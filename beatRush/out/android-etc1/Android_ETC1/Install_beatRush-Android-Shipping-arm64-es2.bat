...
%ADB% %DEVICE% install beatRush-Android-Shipping-arm64-es2.apk
...
%ADB% %DEVICE% push main.13.sk.smdtech.beatrush.obb %STORAGE%/Download/obb/sk.smdtech.beatrush/main.13.sk.smdtech.beatrush.obb
if "%ERRORLEVEL%" NEQ "0" goto Error
